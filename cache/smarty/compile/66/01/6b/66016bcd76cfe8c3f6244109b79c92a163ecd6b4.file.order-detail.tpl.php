<?php /* Smarty version Smarty-3.1.19, created on 2014-09-19 10:24:03
         compiled from "/home/adok/WWW/andrew/themes/default-bootstrap/order-detail.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1289418359541c04431a72d3-46731910%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '66016bcd76cfe8c3f6244109b79c92a163ecd6b4' => 
    array (
      0 => '/home/adok/WWW/andrew/themes/default-bootstrap/order-detail.tpl',
      1 => 1406806856,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1289418359541c04431a72d3-46731910',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_541c04439f7fc9_91513066',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_541c04439f7fc9_91513066')) {function content_541c04439f7fc9_91513066($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/adok/WWW/andrew/tools/smarty/plugins/modifier.replace.php';
if (!is_callable('smarty_function_counter')) include '/home/adok/WWW/andrew/tools/smarty/plugins/function.counter.php';
if (!is_callable('smarty_modifier_regex_replace')) include '/home/adok/WWW/andrew/tools/smarty/plugins/modifier.regex_replace.php';
?>
...
<?php $_tmp40=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('get-file',true,null,"key=".$_tmp39."-".$_tmp40."&amp;id_order=".((string)$_smarty_tpl->tpl_vars['order']->value->id)."&secure_key=".((string)$_smarty_tpl->tpl_vars['order']->value->secure_key)), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Download this product'),$_smarty_tpl);?>
">
									<?php } else { ?>
										<a href="<?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['filename'], ENT_QUOTES, 'UTF-8', true);?>
<?php $_tmp41=ob_get_clean();?><?php ob_start();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['download_hash'], ENT_QUOTES, 'UTF-8', true);?>
<?php $_tmp42=ob_get_clean();?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getPageLink('get-file',true,null,"key=".$_tmp41."-".$_tmp42), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'Download this product'),$_smarty_tpl);?>
">
									<?php }?>
